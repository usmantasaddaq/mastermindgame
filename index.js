...
(function () {
  ...
  function insertGuess() {
    ...
    slots[guess.length].className =
      slots[guess.length].className + " peg " + self.id; // Insert node into page
  ...
  function gameState(state) {
    ...
    if (state === "won") {
      modalMessage.innerHTML =
        '<h2>CONGRATUATION!</h2> <p></p> <button class="large" id="hideModal">PLAY AGAIN</button> <button id="restartGame" class="large primary">Restart</button>';
